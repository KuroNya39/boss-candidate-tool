...
- **API 地址**：打开公司 AI API 系统，选择 Anthropic 格式，复制并粘贴 API URL
...
- **批量打招呼**：选一个分数门槛，自动给分数达标的候选人发送打招呼消息（仅「推荐牛人页」支持）
- **重新开始**：再跑一批

### 分数档位

AI 会根据岗位描述里的 **3 个核心评估维度**（带权重）给候选人打分，再根据学历、经验、技能等**硬性条件**核减分数，最后得出 0-100 分。
...
1. **允许个人使用** —— 个人学习、研究、非商业场景下均可免费使用、修改、分享本软件
