...
3. 选择 **「目标岗位」**（推荐牛人页和搜索页需要；没选就点开始，软件会弹窗提醒）
...
**1. BOSS直聘要保持在独立 Chrome 窗口的前台标签页**

BOSS直聘切到后台标签页时，模拟复制和截图都会失效。请让它在独立 Chrome 窗口的前台标签页保持打开，该窗口被其他窗口盖住也不影响提取。
...
- **搜索页**：跑完不会自动打招呼（打招呼需要使用单独付费的畅聊卡），请根据评分结果自行联系
