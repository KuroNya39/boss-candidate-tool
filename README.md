...
- **邮件通知**：填写完整邮箱地址及邮箱密码，评分结果 Excel 会自动发到你的邮箱。若邮箱开启了「三方客户端安全密码」功能，则须填写客户端安全密码，而非登录密码
...
5. **「开启模拟复制提取」**（可选）：开启后画布型简历提取更快更准，但提取时会短暂占用系统剪贴板，建议在电脑闲置时开启
6. 点击 **「▶ 开始提取分析」**
...
- 主要模块：
  ...
  electron/renderer/                        界面（index.html + style.css + renderer-*.js，脚本按序引入）
