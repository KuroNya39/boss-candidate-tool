...
- **邮件通知（可选）**：填写完整邮箱地址及邮箱密码，评分结果 Excel 会自动发到你的邮箱。若邮箱开启了「三方客户端安全密码」功能，则须填写客户端安全密码，而非登录密码

点击 **「保存」**，出现绿色 **「设置已保存」** 提示即完成。

![在 AI API 系统中复制 API 地址和 Key](docs/images/图3.png)

![软件里的「设置」弹窗（填写地址 / Key / 模型）](docs/images/图4.png)
...
- 确认「设置」里 API 地址 / API Key / 模型名称填写完整
